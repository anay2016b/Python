...
def p11():
    num1 = float(e1.get())
    sum = (num1 / 453.6) 
    l12 = Label(window, text = f"{sum} lb", bg = "light blue", fg = "black", font = ("Times New Roman", 20))
    l12.place(x = 0, y = 600)
def p12():
    num1 = float(e1.get())
    sum = num1 * 2.2046
    l13 = Label(window, text = f"{sum} lb", bg = "light blue", fg = "black", font = ("Times New Roman", 20))
    l13.place(x = 0, y = 600)
def p13():
    num1 = float(e1.get())
    sum = (num1 * 2.2046) / 14
    l14 = Label(window, text = f"{sum} st", bg = "light blue", fg = "black", font = ("Times New Roman", 20))
    l14.place(x = 0, y = 600)
...
l18.pack()
l19.place(x = 250, y = 450)
l20.place(x = 450, y = 450)
l21.place(x = 650, y = 450)
l22.place(x = 850, y = 450)
l23.place(x = 1050, y = 450)
e1.place(x = 50, y = 80)
e2.place(x = 250, y = 80)
e3.place(x = 450, y = 80)
e4.place(x = 650, y = 80)
...
e9.place(x = 50, y = 480)
e10.place(x = 250, y = 480)
e11.place(x = 450, y = 480)
e12.place(x = 650, y = 480)
e13.place(x = 850, y = 480)
...
btn9.place(x = 50, y = 510)
btn10.place(x = 250, y = 510)
btn11.place(x = 450, y = 510)
btn12.place(x = 650, y = 510)
btn13.place(x = 850, y = 510)
